...
const useDiscordRpc = ({ playersRef }: any) => {
  ...
  useEffect(() => {
    if (config.external.discord.enabled && config.external.discord.clientId === "1038592649030017035") {
      const client = new RPC.Client({ transport: 'ipc' });

      if (discordRpc?.client !== "1038592649030017035") {
        client.login({ clientId: "1038592649030017035" }).catch((err: any) => {
